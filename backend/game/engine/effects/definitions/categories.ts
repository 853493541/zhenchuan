...
export const EFFECT_CATEGORY_MAP: Record<EffectType, string> = {
  ...
  DEFENSE_MULTIPLIER: "BUFF",
  ATTACK_DAMAGE_MULTIPLIER: "BUFF",
  ...
  ATTACK_LOCK: "DEBUFF",
  NON_QINGGONG_LOCK: "DEBUFF",
  SILENCE: "DEBUFF",
  DISARM: "DEBUFF",
  INNER_POWER_LOCK: "DEBUFF",
  OUTER_POWER_LOCK: "DEBUFF",
  SILENCE_IMMUNE: "BUFF",
  ...
  TIMED_SOURCE_CENTER_AOE_DAMAGE: "DEBUFF",
  ...
  SPECIAL_ABILITY_BAR: "BUFF",
  NO_JUMP: "BUFF",
  HUN_YA_NU_TAO: "ABILITY",
  REMOVE_SELF_BUFFS: "ABILITY",
