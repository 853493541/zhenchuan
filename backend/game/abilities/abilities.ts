...
export const BASE_ABILITIES: AbilityRecord = {
  ...
  han_di: {
    id: "han_di",
    name: "撼地",
    description: "轻功，以鼠标指定地面位置施放（射程20）\n向指定位置冲刺20尺（0.5秒完成）\n落地时眩晕5尺范围内的敌人3秒\n触发GCD",
    type: "CONTROL",
    target: "OPPONENT",
    range: 20,
    cooldownTicks: 300,
  ...
  lie_ri_zhan: {
    id: "lie_ri_zhan",
    name: "烈日斩",
    description: "瞬发，对目标造成4点伤害，并附加【烈日斩】12秒：防御降低15%。\n若目标已有【银月斩】，伤害翻倍（8点）。\n射程6",
    type: "ATTACK",
    target: "OPPONENT",
    range: 6,
    cooldownTicks: 150,
    ...
    buffs: [
      {
        ...
        durationMs: 12_000,
        description: "防御降低15%",
        effects: [{ type: "DEFENSE_MULTIPLIER", value: 0.85 }],
      },
    ],
  },
  ...
  lin_shi_fei_zhua: {
    id: "lin_shi_fei_zhua",
    name: "临时飞爪",
    description: "轻功，以鼠标指定地面位置施放（射程40）。以飞爪冲刺至指定位置，期间可施放技能；冲刺不提供无敌，受到控制立即中断",
    type: "SUPPORT",
    target: "OPPONENT",
    range: 40,
    cooldownTicks: 300,
  ...
  po_feng: {
    id: "po_feng",
    name: "破风",
    description: "瞬发，射程4。造成1点伤害，附加【破风】（防御降低5%，持续12秒）和【流血】（每2秒1点伤害，持续12秒，最多2层）。若目标拥有控制免疫，额外附加一层【流血】",
    type: "ATTACK",
    target: "OPPONENT",
    range: 4,
    cooldownTicks: 300,
    ...
    buffs: [
      {
        ...
        breakOnPlay: false,
        description: "防御降低5%",
        effects: [{ type: "DEFENSE_MULTIPLIER", value: 0.95 }],
        applyTo: "OPPONENT",
      },
      {
        buffId: 2616,
...
export function setAbilityTag(abilityId: string, tagGroup: TagGroupId, value: string | null) {
  ...
  const isEmpty =
    ...
    !nextEntry.numeric &&
    nextEntry.description === undefined &&
    nextEntry.descriptionReviewStatus === undefined &&
    nextEntry.adControlStatus === undefined &&
